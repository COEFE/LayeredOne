  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            <p>Start chatting about this document</p>
          ...
          <div className="space-y-4">
            ...
            {sending && !messages.some(m => m.isLoading) && (
              <div className="flex justify-start">
                <div className="bg-gray-50 text-gray-600 rounded-2xl rounded-tl-sm border border-gray-200 py-2 px-3 shadow-sm flex items-center space-x-2">
      ...
      <div className="border-t p-3">
        <form onSubmit={handleSubmit} className="flex items-center">
          <div className="relative flex-1">
            <input
              ...
              className="w-full pl-4 pr-10 py-2.5 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
              disabled={sending}
            />
            {error && (
          ...
          <button
            type="submit"
            className={`ml-2 p-2.5 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-sm ${
        ...
        {(document.contentType === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' || 
          document.contentType === 'application/vnd.ms-excel' ||
          document.contentType === 'text/csv') && messages.length > 0 && (
